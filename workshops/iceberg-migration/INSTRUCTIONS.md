...
After those env instructions are completed, select `aws-us-east-1-free` in the server pulldown menu of the query editor and then copy the content from [activities.sql](./activities.sql) into a query editor tab.
